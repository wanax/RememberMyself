...
#ifndef RemeberMe_CommonlyMacros_h
#define RemeberMe_CommonlyMacros_h
...
#define GetConfigure(A,B,C) [Tool getConfigureInfoFrom:A andKey:B inUserDomain:C]
#define SetConfigure(A,B,C) [Tool setConfigureInfoTo:A forKey:B andContent:C]
